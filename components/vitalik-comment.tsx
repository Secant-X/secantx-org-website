...
import TestimonialImg01 from '@/public/images/vitalik.png'
...
export default function VitalikComment() {
  ...
  const items: Item[] = [
    {
      ...
      quote: "We really, truly believe that your access to finance and financial stability shouldn’t depend on your current location, origin, religion, or race.",
