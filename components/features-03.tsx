      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 pb-12 md:pt-32 md:pb-20 border-b border-slate-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Cross-Chain Capability at Your Fingertips</h2>
            <p className="text-lg text-slate-400">Unlock your project's potential with SecantX's multi-chain capabilities, enabling seamless asset exchange across different blockchains, empowering your community to transfer, trade, and manage assets effortlessly and securely.</p>
          </div>
